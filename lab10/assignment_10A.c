...
int main(int argc, char **argv)
{
    ...
    int blocklens[2] = {1, 1};
    // MPI_Aint indices[2] = {0, sizeof(float)}; change

    MPI_Aint indices[2];
    MPI_Get_address(&ctmp.r, &indices[0]);
    MPI_Get_address(&ctmp.i, &indices[1]);
    ...
    /* Make relative */
    // MPI_Type_struct(2, blocklens, indices, old_types, &mystruct); change
